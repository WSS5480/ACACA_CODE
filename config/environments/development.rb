...
Rails.application.configure do
  ...
  # Configure Rails URL options for Active Storage
  ...
  #  open_timeout: 30,
  #  read_timeout: 30,
  #  openssl_verify_mode: OpenSSL::SSL::VERIFY_NONE  # <-- Agregar esta línea para evitar errores de certificado en development
  #}
  
  # Enable error raising for debugging
